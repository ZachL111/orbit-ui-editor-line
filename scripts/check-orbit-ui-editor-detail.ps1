...
$repo = "orbit-ui-editor-line"
$language = "Lua"
$category = "Frontend apps"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/orbit-ui-editor-walkthrough.md")) {
