...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-orbit-ui-editor-detail.ps1

lua tests/test_domain_review.lua

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-orbit-ui-editor-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-orbit-ui-editor-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-orbit_ui_editor_line-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
